...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Company Evaluation Information Summary") ?></h2></div>
        <?php echo message() ?>
        ...
        <form name="standardView" id="standardView" method="post" action="<?php echo url_for('performance/DeleteCompanyEvaluationInfo') ?>">
            ...
            <table cellpadding="0" cellspacing="0" class="data-table">
                <thead>
                    <tr>
                        ...
                        <td scope="col">
                            <?php echo $sorter->sortLink('e.eval_code', __('Evaluation Code'), '@Evaluation', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                            <?php
                            if ($Culture == 'en') {
                            ...
                            ?>
<?php echo $sorter->sortLink($btname, __('Company Evaluation'), '@Evaluation', ESC_RAW); ?>
                        </td>
...
<?php echo $Evaluation->eval_code; ?>
                            ...
                            <td class="">
                                <a href="<?php echo url_for('performance/UpdateCompanyEvaluationInfo?id=' . $encrypt->encrypt($Evaluation->eval_id)) ?>"><?php
                                if ($Culture == 'en') {
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#buttonAdd").click(function() {
                    location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/performance/SaveCompanyEvaluationInfo')) ?>";
