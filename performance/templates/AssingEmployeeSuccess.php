...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Assign Employee Summary") ?></h2></div>
        <?php echo message() ?>
...
<label for="searchMode" style="margin-right: 10px;"><?php echo __("Search By") ?></label>
                ...
                <select name="searchMode" id="searchMode"  style="width: 100px;">
                    ...
                    <option value="supervisor" <?php if($searchMode=="supervisor"){ echo "selected=selected"; }  ?> ><?php echo __("Supervisor Name") ?></option>
                </select>
            ...
            <table cellpadding="0" cellspacing="0" class="data-table">
                <thead>
                    <tr>
                        ...
                        <td scope="col">
                            <?php echo $sorter->sortLink('e.employee_id', __('Employee ID'), '@AssingEmployee', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                            <?php if ($Culture == 'en') {
                            ...
                            <?php echo $sorter->sortLink($btname, __('Employee Name'), '@AssingEmployee', ESC_RAW); ?>
                        </td>
                        ...
                        <?php if ($Culture == 'en') {
                            ...
                            <?php echo $sorter->sortLink($btname, __('Evaluation'), '@AssingEmployee', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                            <?php if ($Culture == 'en') {
                                $btname = 'es.emp_display_name';
                            } else {
                                $btname = 'es.emp_display_name_' . $Culture;
                            } ?>
                            <?php echo $sorter->sortLink($btname, __('Supervisor Name'), '@AssingEmployee', ESC_RAW); ?>
                        </td>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    ?>
                                <tr class="<?php echo $cssClass ?>">
                                    ...
                                    <td class="">
                                        <?php echo $Employee->EmployeeSubordinate->employeeId; ?>
                                    </td>
                    ...
                    ?>
                       ...
                       <td class="">
                                                ...
                                                <?php
                                if ($Culture == 'en') {
                                    echo $Employee->EmployeeSupervisor->emp_display_name;
                                } else {
                                    $abc = 'emp_display_name_' . $Culture;
                                    echo $Employee->EmployeeSupervisor->$abc;
                                    if ($Employee->EmployeeSupervisor->$abc == null) {
                                        echo $Employee->EmployeeSupervisor->emp_display_name;
                                    }
                                }
                    ?>
