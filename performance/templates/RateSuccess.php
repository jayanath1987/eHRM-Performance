...
<div class="outerbox">
    <div class="maincontent">
        ...
        <br class="clear" />
        <form name="standardView" id="standardView" method="post" action="<?php echo url_for('performance/DeleteRate') ?>">
            ...
            <table cellpadding="0" cellspacing="0" class="data-table">
                <thead>
                    <tr>
                        ...
                        <td scope="col">
                            <?php echo $sorter->sortLink('r.rate_code', __('Rate Code'), '@Rate', ESC_RAW); ?>
                        </td>
                        <td scope="col">
                            <?php if ($Culture == 'en') {
                                $btname = 'r.rate_name';
                            ...
                            <?php echo $sorter->sortLink($btname, __('Rate'), '@Rate', ESC_RAW); ?>
                        </td>
                ...
                <tbody>
                    ...
                    ?>
                                <tr class="<?php echo $cssClass ?>">
                                    ...
                                    <td class="">
                                        <a href="<?php echo url_for('performance/UpdateRate?id=' . $encrypt->encrypt($Rate->rate_id)) ?>"><?php
                                if ($Culture == 'en') {
                                    echo $Rate->rate_name;
                                } else {
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#buttonAdd").click(function() {
                    location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/performance/SaveRate')) ?>";
